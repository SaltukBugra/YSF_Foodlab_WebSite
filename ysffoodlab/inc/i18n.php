...
function ysf_dictionary() {
	$dict = array(
		...
		'campaign_expired'    => array( 'Süresi doldu', 'Expired' ),
		'campaign_tomorrow'   => array( 'Yarın gene bekleriz', 'See you again tomorrow' ),
		'campaign_starts'     => array( '%s\'de başlıyor', 'Starts at %s' ),
		'campaign_discount'   => array( 'Kampanya indirimi', 'Offer discount' ),
		'camp_tab'            => array( 'Kampanyalar', 'Campaigns' ),
		'camp_title'          => array( 'Kampanyalar', 'Campaigns' ),
		'camp_lead'           => array( 'Duyuru şeridi ve ana sayfada görünür. Süre bitince “Süresi doldu” olarak kalır. Silmek yalnızca yönetici hesabına açıktır.', 'Shown in the announcement bar and on the homepage. After the end date it stays as “Expired”. Only the administrator account can delete one.' ),
		'camp_add'            => array( 'Yeni kampanya', 'New campaign' ),
		'camp_empty'          => array( 'Henüz kampanya yok.', 'There are no campaigns yet.' ),
		'camp_saved'          => array( 'Kampanya kaydedildi.', 'Campaign saved.' ),
		'camp_deleted'        => array( 'Kampanya silindi.', 'Campaign deleted.' ),
		'camp_delete_ask'     => array( 'Bu kampanyayı kalıcı olarak silmek istiyor musunuz?', 'Delete this campaign permanently?' ),
		'camp_forbidden'      => array( 'Bu işlem yalnız site yöneticisine açıktır.', 'Only the site administrator can do this.' ),
		'camp_name'           => array( 'Kampanya adı', 'Campaign name' ),
		'camp_text'           => array( 'Duyuru metni', 'Announcement' ),
		'camp_name_en'        => array( 'İngilizce ad', 'English name' ),
		'camp_text_en'        => array( 'İngilizce duyuru', 'English announcement' ),
		'camp_scenario'       => array( 'Senaryo', 'Scenario' ),
		'camp_products'       => array( 'Ürünler', 'Products' ),
		'camp_kind'           => array( 'İndirim türü', 'Discount type' ),
		'camp_percent'        => array( 'Yüzde', 'Percent' ),
		'camp_fixed'          => array( 'Tutar', 'Amount' ),
		'camp_value'          => array( 'İndirim değeri', 'Discount value' ),
		'camp_min'            => array( 'Ücret eşiği', 'Spend threshold' ),
		'camp_min_hint'       => array( 'Seçili ürünlerin sepetteki toplam tutarı bu değeri geçince indirim uygulanır.', 'The discount applies once the selected items in the cart go over this amount.' ),
		'camp_bundle'         => array( 'Birlikte toplam tutar', 'Combined total' ),
		'camp_bundle_hint'    => array( 'Seçilen ürünlerin hepsi sepetteyken birer adedinin toplamı bu tutar olur. Fazla adetler kendi fiyatından kalır.', 'When every selected item is in the cart, one of each totals this amount. Extra units keep their own price.' ),
		'camp_start'          => array( 'Başlangıç', 'Start' ),
		'camp_end'            => array( 'Bitiş', 'End' ),
		'camp_end_hint'       => array( 'Bu gün dahil geçerlidir. Ertesi gün “Süresi doldu” olarak kalır.', 'Valid through this day. The next day it stays as “Expired”.' ),
		'camp_time_start'     => array( 'Saat başlangıcı', 'Start time' ),
		'camp_time_end'       => array( 'Saat bitişi', 'End time' ),
		'camp_time_hint'      => array( 'İsteğe bağlı. Aralık bitince kampanya ertesi güne sarkıyorsa “Yarın gene bekleriz” görünür.', 'Optional. After the hours end, if the campaign continues tomorrow it shows “See you again tomorrow”.' ),
		'camp_delete'         => array( 'Sil', 'Delete' ),

		'ann_tab'             => array( 'Duyurular', 'Announcements' ),
		'ann_title'           => array( 'Duyurular', 'Announcements' ),
		'ann_lead'            => array( 'Başlık, kısa açıklama ve görsel yeterli. Üst şeritte ve ana sayfada görünür. Silme yalnızca yönetici hesabına açıktır.', 'Title, short description and an image are enough. Shown in the top bar and on the homepage. Only the administrator account can delete one.' ),
		'ann_add'             => array( 'Yeni duyuru', 'New announcement' ),
		'ann_empty'           => array( 'Henüz duyuru yok.', 'There are no announcements yet.' ),
		'ann_saved'           => array( 'Duyuru kaydedildi.', 'Announcement saved.' ),
		'ann_deleted'         => array( 'Duyuru silindi.', 'Announcement deleted.' ),
		'ann_delete_ask'      => array( 'Bu duyuruyu kalıcı olarak silmek istiyor musunuz?', 'Delete this announcement permanently?' ),
		'ann_forbidden'       => array( 'Bu işlem yalnız site yöneticisine açıktır.', 'Only the site administrator can do this.' ),
		'ann_name'            => array( 'Başlık', 'Title' ),
		'ann_excerpt'         => array( 'Kısa açıklama', 'Short description' ),
		'ann_excerpt_hint'    => array( 'Üst şerit ve ana sayfa kartında görünür.', 'Shown in the top bar and on homepage cards.' ),
		'ann_content'         => array( 'İçerik', 'Content' ),
		'ann_show_bar'        => array( 'Üst duyuru şeridinde göster', 'Show in the top announcement bar' ),
		...
		'acc_verify_title'    => array( 'E-posta doğrulama', 'E-mail verification' ),
		'acc_verify_lead'     => array( 'E-postanıza 6 haneli bir kod gönderdik. Üyeliği tamamlamak için kodu girin.', 'We sent a 6-digit code to your e-mail. Enter it to finish creating your account.' ),
		'acc_verify_code'     => array( 'Doğrulama kodu', 'Verification code' ),
		...
		'acc_verify_sent'     => array( 'Doğrulama kodu %s adresine gönderildi.', 'A verification code was sent to %s.' ),
		'acc_verify_onscreen' => array( 'E-posta şu an gönderilemedi. Üyeliği tamamlamak için kodunuz: %s', 'The e-mail could not be sent. Use this code to finish signing up: %s' ),
		'acc_verify_mail'     => array( 'Üyeliğinizi tamamlamak için doğrulama kodunuz: %s. Kod 30 dakika geçerlidir.', 'Your verification code to finish signing up is %s. It is valid for 30 minutes.' ),
		'acc_verify_wrong'    => array( 'Doğrulama kodu hatalı.', 'That verification code is wrong.' ),
		...
		'acc_register_btn'    => array( 'Üye ol', 'Create an account' ),
		...
		'tfa_email_prompt'    => array( 'Şifre doğru. Karekod için e-postanıza gelen 6 haneli kodu yazın.', 'Password is correct. Enter the 6-digit code from your e-mail to see the QR code.' ),
		'tfa_email_sent'      => array( 'Doğrulama kodu %s adresine gönderildi.', 'A verification code was sent to %s.' ),
		'tfa_email_mail'      => array( 'Yönetici Authenticator kurulumu için doğrulama kodunuz: %s. Kod 10 dakika geçerlidir.', 'Your administrator authenticator setup code is %s. It is valid for 10 minutes.' ),
		'tfa_email_code'      => array( 'E-posta doğrulama kodu', 'E-mail verification code' ),
		'tfa_email_continue'  => array( 'E-posta kodunu doğrula', 'Verify e-mail code' ),
		'tfa_or_pass_wrong'   => array( 'Kod veya şifre hatalı.', 'The code or password is incorrect.' ),
		'tfa_setup_prompt'    => array( 'E-posta doğrulandı. Authenticator uygulamasıyla karekodu tarayıp 6 haneli kodu yazın.', 'E-mail verified. Scan the QR code with your authenticator app and enter the 6-digit code.' ),
